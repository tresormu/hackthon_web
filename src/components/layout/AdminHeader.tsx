      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-2">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[11px] text-emerald-600 font-medium mt-1 uppercase tracking-wider flex items-center justify-end gap-1">
              <Shield className="w-3 h-3" /> System Admin
            </p>
          </div>
          <div className="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center border border-emerald-200 cursor-pointer hover:border-emerald-400 transition-colors">
            <span className="text-emerald-700 font-bold text-sm">{initials}</span>
          </div>
        </div>
      </div>
    </header>
